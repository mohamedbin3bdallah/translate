          ...
          <div class="">
            <div class="page-title">
              <div class="title_left" style="width:100%;">
                <h3 style="text-align:center;"><?php echo lang('add_course'); ?></h3>
              </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						echo form_open_multipart('courses/create', $attributes);
					?>
					...
					?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						 <?php								$ourtypes[0] = lang('select');								foreach($langs as $lang)								{									$ourtypes[$lang->code] = $lang->title;								}																			echo form_dropdown('lang', $ourtypes, array(), 'id="lang" class="form-control"');						?>
                        </div>
