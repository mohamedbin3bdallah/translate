                  ...
                  <div class="x_content">
					...
					?>
					  ...
					  <div class="form-group">
						...
						?>
                        <div class="col-md-6 col-sm-6 col-xs-12 <?php echo $input_class; ?>">
						  <?php														$ourtypes = array();							$ourtypes['egp'] = lang('egp');															$ourtypes['sar'] = lang('sar');							$ourtypes['usd'] = lang('usd');							echo form_dropdown('currency', $ourtypes, set_value('currency',$system->currency), 'class="form-control"');
						?>
                        </div>
                      </div>
					  <div class="form-group">
