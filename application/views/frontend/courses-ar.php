	...
	<div class="howitwork margin-0 text-center" id="howitwork">
		<div class="content-header">
			<h4 class="bold">الكورسات</h4>
			<a href="<?php echo base_url(); ?>">	الرئيسيه</a> /
			<a href="<?php echo base_url().'courses/ar'; ?>">	الكورسات</a>
		</div>
	</div>
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<form action="<?php echo base_url().'courses_action/ar/'.$page; ?>" method="post" class="form-quote no-shadow no-top half-select">
					<?php echo validation_errors(); ?>

					<input type="hidden" name="course" value="" id="course">
					<p>الاسم كما تود ان يظهر على الشهاده :</p>
					...
					-->
					<p>باختياري (تقديم) ، أقر أنا بأنني أتحمل المسؤولية الأكاديمية والمالية بشأن البيانات المدرجة في طلب التسجيل الخاص بي.</p>
					<div class="input-check">
